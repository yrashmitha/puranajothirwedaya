...
SYSTEM_PROMPT = read_file("prompts/breakup_system_prompt.txt")
BIRTH_DATA = read_file("prompts/couple_birth_data.txt")

sections = [
    "දෙදෙනාගේ ජන්ම පත්‍රයන්හි පවතින සුබදායක ග්‍රහ ගැළපීම් සහ ශක්තිමත් සාධක",
    "පෞරුෂත්වයන් අතර පවතින සමානකම් සහ එකිනෙකාට අනුපූරක වන චරිත ලක්ෂණ",
    "අදහස් හුවමාරුවේ පවතින ගුණාත්මක බව සහ බුද්ධිමය මට්ටමින් දෙදෙනා අතර ඇති අවබෝධය",
    "දෙදෙනාගේ ජන්ම පත්‍රයන්හි ග්‍රහ ගැළපීම පිළිබඳ මූලික විග්‍රහය",
    "ග්‍රහ පිහිටීම් අනුව වර්ධනය කරගත යුතු ඉවසීම සහ චිත්තවේග කළමනාකරණය පිළිබඳ විග්‍රහය",
    "චරිත ස්වභාවය, මානසික ගැළපීම සහ අදහස් හුවමාරුවේ පවතින ස්වභාවය",
    "ග්‍රහ පිහිටීම් අනුව මතභේද හෝ වැරදි වැටහීම් ඇති වීමට පවතින ප්‍රවණතාවය",
    "දෙදෙනා අතර ඇති විය හැකි සුළු මතභේද ආදරයෙන් සහ බුද්ධියෙන් සමනය කර ගැනීමට ඇති මනෝවිද්‍යාත්මක මඟ පෙන්වීම්",
    "දෙදෙනාගේම වර්තමාන දශා කාලයන් සහ ග්‍රහ ගෝචරය සබඳතාවයට බලපාන අයුරු (2026)",
    "ජ්‍යොතිෂමය සාධක අනුව දැනට වෙන්වී ඇතිනම් නැවත එක්වීමේ හෝ එසේ නොමැතිනම් සබඳතාවය ඉදිරියට යාමේ සම්භාවිතාව",
    "වර්තමාන මානසික පීඩනයක් ඇතිනම් සමනය කර ගැනීමට සහ සුවපත් වීමට ඇති මඟ පෙන්වීම්",
    "සබඳතාවයේ ගැටලු අවම කර ගැනීමට අදාළ බෞද්ධ වත්පිළිවෙත් සහ පිළියම්",
    "දෙදෙනාගේ ග්‍රහ පිහිටීම් අනුව ජීවන ගමනේ ඉදිරි පියවර පිළිබඳ සාරාංශය",
    "දෙදෙනාගේම ග්‍රහ දෝශ භංග වී වඩාත් යහපත් විවාහ ජීවිතයක් ගත කිරීමට අනෙකාගෙ තිබිය යුතු ග්‍රහ පිහිටීම් දෙදෙනාට වෙන වෙනම"
]
    ...
    try:
        ...
        for index, sec in enumerate(sections):
            ...
            task_prompt = (f"දැන් [{sec}] පිළිබඳව {limit_text} "
                           ...
                           f"6. වර්තමානය 2026 ලෙස ගන්න."
                           f"7. ආමන්ත්‍රණ සහ සමාප්ති වාක්‍ය තහනම: ගරු පාරිභෝගිකයාණනි, ආයුබෝවන් වැනි කිසිදු ආරම්භක ආමන්ත්‍රණයක් හෝ ස්තූතියි, සුබ පතමි වැනි කිසිදු සමාප්ති වාක්‍යයක් වාර්තාවේ කිසිදු තැනක භාවිතා නොකරන්න."
                           )
        ...
        # අවසාන සුරැකීම
        output_file = "outputs/melani.docx"
